"""
Two-phase fine-tuning for EfficientNetB1:
...
base = tf.keras.applications.EfficientNetB1(
    include_top=False, weights="imagenet", input_shape=(240, 240, 3)
)
...
cbs_1 = [
    ModelCheckpoint("efficientnet_b1_phase1_best.keras",
...
cbs_2 = [
    ModelCheckpoint("efficientnet_b1_fine_tuned_best.keras",
                    monitor="val_accuracy", save_best_only=True, verbose=1),
    ReduceLROnPlateau(monitor='val_loss', factor=0.1,
...
model.save("efficientnet_b1_fine_tuned_final.keras")
