"""
Phase 1 only (frozen base): train a new head on top of pretrained EfficientNetB1.
"""
...
callbacks = [
    ModelCheckpoint("efficientnet_b1_fe_best.keras",
...
model.save("efficientnet_b1_feature_extraction.keras")
