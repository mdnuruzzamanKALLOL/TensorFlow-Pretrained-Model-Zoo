...
EfficientNetB1 is a compound-scaled EfficientNet variant. Every block uses
...
| Stage 3 (k=5, n= 3) | in= 24 → out= 40, expand=6, stride=2 |
| Stage 4 (k=3, n= 4) | in= 40 → out= 80, expand=6, stride=2 |
| Stage 5 (k=5, n= 4) | in= 80 → out=112, expand=6, stride=1 |
| Stage 6 (k=5, n= 5) | in=112 → out=192, expand=6, stride=2 |
| Stage 7 (k=3, n= 2) | in=192 → out=320, expand=6, stride=1 |
...
EfficientNetB1/
├── NoteBook/
│   └── EfficientNetB1.ipynb          # 17-cell interactive walkthrough
├── Python Scripts/
│   ├── EfficientNetB1.py             # Architecture from scratch
