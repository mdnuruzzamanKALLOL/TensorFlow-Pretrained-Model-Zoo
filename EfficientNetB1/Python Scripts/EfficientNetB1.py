...
BLOCK_ARGS = [
    {"k":3, "n": 2, "in_ch": 32, "out_ch": 16, "expand":1, "stride":1, "se":0.25},
    {"k":3, "n": 3, "in_ch": 16, "out_ch": 24, "expand":6, "stride":2, "se":0.25},
    {"k":5, "n": 3, "in_ch": 24, "out_ch": 40, "expand":6, "stride":2, "se":0.25},
    {"k":3, "n": 4, "in_ch": 40, "out_ch": 80, "expand":6, "stride":2, "se":0.25},
    {"k":5, "n": 4, "in_ch": 80, "out_ch":112, "expand":6, "stride":1, "se":0.25},
    {"k":5, "n": 5, "in_ch":112, "out_ch":192, "expand":6, "stride":2, "se":0.25},
    {"k":3, "n": 2, "in_ch":192, "out_ch":320, "expand":6, "stride":1, "se":0.25},
]


def build_efficientnet_b1(num_classes=1000, input_shape=(240, 240, 3)):
    """EfficientNet-B1: stem=32, head_conv=1280, input=240x240, dropout=0.2."""
    inputs = keras.Input(shape=input_shape)

    # Stem: 3x3 conv, stride 2
    x = _conv_bn(inputs, 32, 3, strides=2)
    ...
    return keras.Model(inputs, outputs, name="EfficientNetB1")
