"""
Phase 1 only (frozen base): train a new head on top of pretrained ConvNeXtLarge.
"""
...
callbacks = [
    ModelCheckpoint("convnext_large_fe_best.keras",
...
model.save("convnext_large_feature_extraction.keras")
