"""
Two-phase fine-tuning for ConvNeXtLarge:
...
cbs_1 = [
    ModelCheckpoint("convnext_large_phase1_best.keras",
...
cbs_2 = [
    ModelCheckpoint("convnext_large_fine_tuned_best.keras",
                    monitor="val_accuracy", save_best_only=True, verbose=1),
    ReduceLROnPlateau(monitor='val_loss', factor=0.1,
...
model.save("convnext_large_fine_tuned_final.keras")
