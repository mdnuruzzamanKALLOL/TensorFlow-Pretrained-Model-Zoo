"""
Two-phase fine-tuning for EfficientNetB0:
...
cbs_1 = [
    ModelCheckpoint("efficientnet_b0_phase1_best.keras",
...
cbs_2 = [
    ModelCheckpoint("efficientnet_b0_fine_tuned_best.keras",
                    monitor="val_accuracy", save_best_only=True, verbose=1),
    ReduceLROnPlateau(monitor='val_loss', factor=0.1,
...
model.save("efficientnet_b0_fine_tuned_final.keras")
