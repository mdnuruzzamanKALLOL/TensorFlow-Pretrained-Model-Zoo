"""
Phase 1 only (frozen base): train a new head on top of pretrained EfficientNetB0.
"""
...
callbacks = [
    ModelCheckpoint("efficientnet_b0_fe_best.keras",
...
model.save("efficientnet_b0_feature_extraction.keras")
