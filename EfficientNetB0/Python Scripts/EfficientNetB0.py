...
BLOCK_ARGS = [
    {"k":3, "n": 1, "in_ch": 32, "out_ch": 16, "expand":1, "stride":1, "se":0.25},
    {"k":3, "n": 2, "in_ch": 16, "out_ch": 24, "expand":6, "stride":2, "se":0.25},
    {"k":5, "n": 2, "in_ch": 24, "out_ch": 40, "expand":6, "stride":2, "se":0.25},
    {"k":3, "n": 3, "in_ch": 40, "out_ch": 80, "expand":6, "stride":2, "se":0.25},
    {"k":5, "n": 3, "in_ch": 80, "out_ch":112, "expand":6, "stride":1, "se":0.25},
    {"k":5, "n": 4, "in_ch":112, "out_ch":192, "expand":6, "stride":2, "se":0.25},
    {"k":3, "n": 1, "in_ch":192, "out_ch":320, "expand":6, "stride":1, "se":0.25},
]


def build_efficientnet_b0(num_classes=1000, input_shape=(224, 224, 3)):
    """EfficientNet-B0: stem=32, head_conv=1280, input=224x224, dropout=0.2."""
