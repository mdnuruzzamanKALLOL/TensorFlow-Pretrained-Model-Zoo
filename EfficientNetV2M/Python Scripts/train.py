"""Train EfficientNetV2M from scratch."""
import tensorflow as tf
from tensorflow import keras
from tensorflow.keras.preprocessing.image import ImageDataGenerator
from tensorflow.keras.callbacks import ModelCheckpoint, ReduceLROnPlateau
from EfficientNetV2M import build_efficientnetv2m
...
model = build_efficientnetv2m(num_classes=NUM_CLASSES)
model.compile(
...
callbacks = [
    ModelCheckpoint("efficientnetv2m_best.keras", monitor="val_accuracy", save_best_only=True, verbose=1),
    ReduceLROnPlateau(monitor="val_loss", factor=0.1, patience=5, min_lr=1e-7, verbose=1),
]
model.fit(train_data, validation_data=val_data, epochs=EPOCHS, callbacks=callbacks)
print("Done. Saved: efficientnetv2m_best.keras")
