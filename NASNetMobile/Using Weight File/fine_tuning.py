...
# NASNet layer names are NAS-generated and don't follow simple conv-block patterns.
# Index-based unfreezing is the most reliable approach.
print('\nPhase 2: Fine-tuning — last 30%% of backbone layers (lr=1e-5)')
base_model.trainable = True
n = len(base_model.layers)
freeze_until = int(n * 0.70)           # freeze first 70%
...
callbacks = [
    keras.callbacks.ModelCheckpoint(
        'nasnetmobile_ft.keras', monitor='val_accuracy',
...
print('Saved: nasnetmobile_ft.keras')
