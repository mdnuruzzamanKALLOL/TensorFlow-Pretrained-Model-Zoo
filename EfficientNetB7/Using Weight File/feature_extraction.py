"""
Phase 1 only (frozen base): train a new head on top of pretrained EfficientNetB7.
"""
...
callbacks = [
    ModelCheckpoint("efficientnet_b7_fe_best.keras",
...
model.save("efficientnet_b7_feature_extraction.keras")
