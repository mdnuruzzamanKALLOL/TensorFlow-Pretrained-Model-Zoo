...
BLOCK_ARGS = [
    {"k":3, "n": 3, "in_ch": 48, "out_ch": 24, "expand":1, "stride":1, "se":0.25},
    {"k":3, "n": 5, "in_ch": 24, "out_ch": 40, "expand":6, "stride":2, "se":0.25},
    {"k":5, "n": 5, "in_ch": 40, "out_ch": 64, "expand":6, "stride":2, "se":0.25},
    {"k":3, "n": 7, "in_ch": 64, "out_ch":128, "expand":6, "stride":2, "se":0.25},
    {"k":5, "n": 7, "in_ch":128, "out_ch":176, "expand":6, "stride":1, "se":0.25},
    {"k":5, "n": 9, "in_ch":176, "out_ch":304, "expand":6, "stride":2, "se":0.25},
    {"k":3, "n": 3, "in_ch":304, "out_ch":512, "expand":6, "stride":1, "se":0.25},
]


def build_efficientnet_b5(num_classes=1000, input_shape=(456, 456, 3)):
    """EfficientNet-B5: stem=48, head_conv=2048, input=456x456, dropout=0.4."""
    inputs = keras.Input(shape=input_shape)

    # Stem: 3x3 conv, stride 2
    x = _conv_bn(inputs, 48, 3, strides=2)
    ...
    return keras.Model(inputs, outputs, name="EfficientNetB5")
