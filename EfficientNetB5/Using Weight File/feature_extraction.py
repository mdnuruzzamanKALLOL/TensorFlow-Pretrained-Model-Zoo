"""
Phase 1 only (frozen base): train a new head on top of pretrained EfficientNetB5.
"""
...
callbacks = [
    ModelCheckpoint("efficientnet_b5_fe_best.keras",
...
model.save("efficientnet_b5_feature_extraction.keras")
