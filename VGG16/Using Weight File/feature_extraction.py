...
model   = keras.Model(inputs=base_model.input, outputs=outputs, name='vgg16_fe')
...
# ── Data generators — VGG16 preprocessing (subtracts ImageNet BGR mean) ──
...
callbacks = [
    keras.callbacks.ModelCheckpoint(
        'vgg16_fe.keras', monitor='val_accuracy',
