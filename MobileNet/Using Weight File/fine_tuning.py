...
# ── Phase 2: Fine-tune last 3 DW blocks (conv_dw_11..13, conv_pw_11..13) ──
print('\nPhase 2: Fine-tuning — DW blocks 11-13 unfrozen (lr=1e-5)')
...
callbacks = [
    keras.callbacks.ModelCheckpoint(
        'mobilenet_ft.keras', monitor='val_accuracy',
...
print('Saved: mobilenet_ft.keras')
