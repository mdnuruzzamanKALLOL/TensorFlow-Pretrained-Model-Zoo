...
def build_densenet169(num_classes=1000, input_shape=(224, 224, 3)):
    """DenseNet-169: blocks=[6, 12, 32, 32], growth_rate=32, compression=0.5."""
    blocks = [6, 12, 32, 32]
    ...
    return keras.Model(inputs, outputs, name="DenseNet169")
