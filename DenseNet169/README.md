...
DenseNet169 is a densely connected convolutional network where each layer
...
|-----------------|-------|
| Growth rate (k) | 32 |
| Dense blocks    | 4 blocks — [6, 12, 32, 32] layers |
| Compression (θ) | 0.5 |
...
| Dense Block 3 (32 layers)| 1280 ch → Transition → 640 ch, 7×7  |
| Dense Block 4 (32 layers)| 1664 ch, 7×7 |
...
DenseNet169/
├── NoteBook/
│   └── DenseNet169.ipynb          # 17-cell interactive walkthrough
├── Python Scripts/
│   ├── DenseNet169.py             # Architecture from scratch
