"""
Phase 1 only (frozen base): train a new classification head on top of
pretrained DenseNet169 (ImageNet weights).
"""
...
callbacks = [
    ModelCheckpoint("densenet169_fe_best.keras",
...
model.save("densenet169_feature_extraction.keras")
