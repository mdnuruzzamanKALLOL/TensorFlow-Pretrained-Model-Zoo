...
ConvNeXtBase is a pure ConvNet that adopts key design choices from Vision
...
| Stage | Output |
|-------|--------|
| Stem (Conv 4×4, stride 4) | 128 ch, 56×56 |
| Stage 1 (3 blocks)    | 128 ch, 56×56 |
| Downsample + Stage 2 (3 blocks) | 256 ch, 28×28 |
| Downsample + Stage 3 (27 blocks) | 512 ch, 14×14 |
| Downsample + Stage 4 (3 blocks) | 1024 ch,  7×7  |
...
ConvNeXtBase/
├── NoteBook/
│   └── ConvNeXtBase.ipynb          # 17-cell interactive walkthrough
├── Python Scripts/
│   ├── ConvNeXtBase.py             # Architecture from scratch
