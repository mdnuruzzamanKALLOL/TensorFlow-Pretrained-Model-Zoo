...
BLOCK_ARGS = [
    {"k":3, "n": 2, "in_ch": 40, "out_ch": 24, "expand":1, "stride":1, "se":0.25},
    {"k":3, "n": 3, "in_ch": 24, "out_ch": 32, "expand":6, "stride":2, "se":0.25},
    {"k":5, "n": 3, "in_ch": 32, "out_ch": 48, "expand":6, "stride":2, "se":0.25},
    {"k":3, "n": 5, "in_ch": 48, "out_ch": 96, "expand":6, "stride":2, "se":0.25},
    {"k":5, "n": 5, "in_ch": 96, "out_ch":136, "expand":6, "stride":1, "se":0.25},
    {"k":5, "n": 6, "in_ch":136, "out_ch":232, "expand":6, "stride":2, "se":0.25},
    {"k":3, "n": 2, "in_ch":232, "out_ch":384, "expand":6, "stride":1, "se":0.25},
]


def build_efficientnet_b3(num_classes=1000, input_shape=(300, 300, 3)):
    """EfficientNet-B3: stem=40, head_conv=1536, input=300x300, dropout=0.3."""
    inputs = keras.Input(shape=input_shape)

    # Stem: 3x3 conv, stride 2
    x = _conv_bn(inputs, 40, 3, strides=2)
