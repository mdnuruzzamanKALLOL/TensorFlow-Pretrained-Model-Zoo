"""
Two-phase fine-tuning for EfficientNetB3:
...
cbs_1 = [
    ModelCheckpoint("efficientnet_b3_phase1_best.keras",
...
cbs_2 = [
    ModelCheckpoint("efficientnet_b3_fine_tuned_best.keras",
                    monitor="val_accuracy", save_best_only=True, verbose=1),
    ReduceLROnPlateau(monitor='val_loss', factor=0.1,
...
model.save("efficientnet_b3_fine_tuned_final.keras")
