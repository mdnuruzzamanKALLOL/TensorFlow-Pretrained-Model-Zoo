"""
Phase 1 only (frozen base): train a new head on top of pretrained EfficientNetB3.
"""
...
callbacks = [
    ModelCheckpoint("efficientnet_b3_fe_best.keras",
...
model.save("efficientnet_b3_feature_extraction.keras")
