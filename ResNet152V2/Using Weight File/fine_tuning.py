...
model   = keras.Model(inputs=base_model.input, outputs=outputs, name='resnet152v2_ft')
...
# ── Phase 2: Fine-tune conv4 (36 blocks) + conv5 + post_bn + post_relu ──
print('\nPhase 2: Fine-tuning — conv4 (36 blocks) + conv5 + post_bn + post_relu (lr=1e-5)')
...
callbacks = [
    keras.callbacks.ModelCheckpoint(
        'resnet152v2_ft.keras', monitor='val_accuracy',
...
print('Saved: resnet152v2_ft.keras')
