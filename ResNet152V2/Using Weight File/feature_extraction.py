...
model   = keras.Model(inputs=base_model.input, outputs=outputs, name='resnet152v2_fe')
...
# ResNet152V2 uses tf-mode: x/127.5 - 1.0
...
callbacks = [
    keras.callbacks.ModelCheckpoint(
        'resnet152v2_fe.keras', monitor='val_accuracy',
...
print('Saved: resnet152v2_fe.keras')
