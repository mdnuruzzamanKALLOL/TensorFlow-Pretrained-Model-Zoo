"""
Phase 1 only (frozen base): train a new head on top of pretrained EfficientNetB6.
"""
...
callbacks = [
    ModelCheckpoint("efficientnet_b6_fe_best.keras",
...
model.save("efficientnet_b6_feature_extraction.keras")
