...
BLOCK_ARGS = [
    {"k":3, "n": 2, "in_ch": 48, "out_ch": 24, "expand":1, "stride":1, "se":0.25},
    {"k":3, "n": 4, "in_ch": 24, "out_ch": 32, "expand":6, "stride":2, "se":0.25},
    {"k":5, "n": 4, "in_ch": 32, "out_ch": 56, "expand":6, "stride":2, "se":0.25},
    {"k":3, "n": 6, "in_ch": 56, "out_ch":112, "expand":6, "stride":2, "se":0.25},
    {"k":5, "n": 6, "in_ch":112, "out_ch":160, "expand":6, "stride":1, "se":0.25},
    {"k":5, "n": 8, "in_ch":160, "out_ch":272, "expand":6, "stride":2, "se":0.25},
    {"k":3, "n": 2, "in_ch":272, "out_ch":448, "expand":6, "stride":1, "se":0.25},
]


def build_efficientnet_b4(num_classes=1000, input_shape=(380, 380, 3)):
    """EfficientNet-B4: stem=48, head_conv=1792, input=380x380, dropout=0.4."""
    ...
    return keras.Model(inputs, outputs, name="EfficientNetB4")
