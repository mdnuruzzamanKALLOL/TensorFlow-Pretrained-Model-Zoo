"""
Two-phase fine-tuning for EfficientNetB4:
...
base = tf.keras.applications.EfficientNetB4(
    include_top=False, weights="imagenet", input_shape=(380, 380, 3)
)
...
cbs_1 = [
    ModelCheckpoint("efficientnet_b4_phase1_best.keras",
...
cbs_2 = [
    ModelCheckpoint("efficientnet_b4_fine_tuned_best.keras",
                    monitor="val_accuracy", save_best_only=True, verbose=1),
    ReduceLROnPlateau(monitor='val_loss', factor=0.1,
...
model.save("efficientnet_b4_fine_tuned_final.keras")
