"""
Phase 1 only (frozen base): train a new head on top of pretrained EfficientNetB4.
"""
...
callbacks = [
    ModelCheckpoint("efficientnet_b4_fe_best.keras",
...
model.save("efficientnet_b4_feature_extraction.keras")
