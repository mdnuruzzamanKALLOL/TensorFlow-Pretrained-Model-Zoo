...
ConvNeXtSmall is a pure ConvNet that adopts key design choices from Vision
...
| Downsample + Stage 3 (27 blocks) | 384 ch, 14×14 |
...
ConvNeXtSmall/
├── NoteBook/
│   └── ConvNeXtSmall.ipynb          # 17-cell interactive walkthrough
├── Python Scripts/
│   ├── ConvNeXtSmall.py             # Architecture from scratch
