"""
Phase 1 only (frozen base): train a new head on top of pretrained ConvNeXtSmall.
"""
...
callbacks = [
    ModelCheckpoint("convnext_small_fe_best.keras",
...
model.save("convnext_small_feature_extraction.keras")
