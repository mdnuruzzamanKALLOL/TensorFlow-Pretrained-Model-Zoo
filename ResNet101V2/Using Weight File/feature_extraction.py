...
model   = keras.Model(inputs=base_model.input, outputs=outputs, name='resnet101v2_fe')
...
# ── Data generators — ResNet101V2 uses tf-mode preprocessing: x/127.5 - 1.0 ──
...
callbacks = [
    keras.callbacks.ModelCheckpoint(
        'resnet101v2_fe.keras', monitor='val_accuracy',
...
print('Saved: resnet101v2_fe.keras')
