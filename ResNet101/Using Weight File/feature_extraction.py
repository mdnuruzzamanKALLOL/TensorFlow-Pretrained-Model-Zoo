...
model   = keras.Model(inputs=base_model.input, outputs=outputs, name='resnet101_fe')
...
# ── Data generators — same preprocessing as ResNet50 (subtract BGR mean) ──
...
callbacks = [
    keras.callbacks.ModelCheckpoint(
        'resnet101_fe.keras', monitor='val_accuracy',
...
print('Saved: resnet101_fe.keras')
