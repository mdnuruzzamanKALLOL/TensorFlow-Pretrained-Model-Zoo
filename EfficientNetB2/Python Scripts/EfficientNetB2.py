...
BLOCK_ARGS = [
    ...
    {"k":5, "n": 3, "in_ch": 24, "out_ch": 48, "expand":6, "stride":2, "se":0.25},
    {"k":3, "n": 4, "in_ch": 48, "out_ch": 88, "expand":6, "stride":2, "se":0.25},
    {"k":5, "n": 4, "in_ch": 88, "out_ch":120, "expand":6, "stride":1, "se":0.25},
    {"k":5, "n": 5, "in_ch":120, "out_ch":208, "expand":6, "stride":2, "se":0.25},
    {"k":3, "n": 2, "in_ch":208, "out_ch":352, "expand":6, "stride":1, "se":0.25},
]


def build_efficientnet_b2(num_classes=1000, input_shape=(260, 260, 3)):
    """EfficientNet-B2: stem=32, head_conv=1408, input=260x260, dropout=0.3."""
