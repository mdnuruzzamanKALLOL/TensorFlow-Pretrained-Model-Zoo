"""
Phase 1 only (frozen base): train a new head on top of pretrained EfficientNetB2.
"""
...
callbacks = [
    ModelCheckpoint("efficientnet_b2_fe_best.keras",
...
model.save("efficientnet_b2_feature_extraction.keras")
