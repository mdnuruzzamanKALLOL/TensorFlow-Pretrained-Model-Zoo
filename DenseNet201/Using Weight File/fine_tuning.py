"""
Two-phase fine-tuning for DenseNet201:
...
cbs_1 = [
    ModelCheckpoint("densenet201_phase1_best.keras",
...
cbs_2 = [
    ModelCheckpoint("densenet201_fine_tuned_best.keras",
                    monitor="val_accuracy", save_best_only=True, verbose=1),
    ReduceLROnPlateau(monitor='val_loss', factor=0.1,
...
model.save("densenet201_fine_tuned_final.keras")
