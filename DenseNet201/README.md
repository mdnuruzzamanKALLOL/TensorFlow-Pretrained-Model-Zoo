...
DenseNet201 is a densely connected convolutional network where each layer
...
|-----------------|-------|
| Growth rate (k) | 32 |
| Dense blocks    | 4 blocks — [6, 12, 48, 32] layers |
| Compression (θ) | 0.5 |
...
| Dense Block 3 (48 layers)| 1792 ch → Transition → 896 ch, 7×7  |
| Dense Block 4 (32 layers)| 1920 ch, 7×7 |
...
DenseNet201/
├── NoteBook/
│   └── DenseNet201.ipynb          # 17-cell interactive walkthrough
├── Python Scripts/
│   ├── DenseNet201.py             # Architecture from scratch
