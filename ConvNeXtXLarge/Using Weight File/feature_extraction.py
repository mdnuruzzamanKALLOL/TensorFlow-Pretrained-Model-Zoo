"""
Phase 1 only (frozen base): train a new head on top of pretrained ConvNeXtXLarge.
"""
...
callbacks = [
    ModelCheckpoint("convnext_xlarge_fe_best.keras",
...
model.save("convnext_xlarge_feature_extraction.keras")
