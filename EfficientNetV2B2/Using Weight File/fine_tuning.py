"""Two-phase fine-tuning for EfficientNetV2B2."""
...
model=keras.Model(inputs,outputs,name="EfficientNetV2B2_ft")
model.compile(optimizer=keras.optimizers.Adam(1e-3),loss="categorical_crossentropy",metrics=["accuracy"])
cb1=[ModelCheckpoint("efficientnetv2b2_ft_p1.keras",monitor="val_accuracy",save_best_only=True,verbose=1),
...
cb2=[ModelCheckpoint("efficientnetv2b2_ft_best.keras",monitor="val_accuracy",save_best_only=True,verbose=1),
...
print("Done. Best: efficientnetv2b2_ft_best.keras")
