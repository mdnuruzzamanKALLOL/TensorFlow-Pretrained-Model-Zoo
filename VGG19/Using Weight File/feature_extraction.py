...
model   = keras.Model(inputs=base_model.input, outputs=outputs, name='vgg19_fe')
...
# ── Data generators — VGG19 preprocessing (subtracts ImageNet BGR mean) ──
...
callbacks = [
    keras.callbacks.ModelCheckpoint(
        'vgg19_fe.keras', monitor='val_accuracy',
