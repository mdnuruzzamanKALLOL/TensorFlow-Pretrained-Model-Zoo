...
ConvNeXtTiny is a pure ConvNet that adopts key design choices from Vision
...
| Stage | Output |
|-------|--------|
| Stem (Conv 4×4, stride 4) | 96 ch, 56×56 |
| Stage 1 (3 blocks)    | 96 ch, 56×56 |
| Downsample + Stage 2 (3 blocks) | 192 ch, 28×28 |
| Downsample + Stage 3 (9 blocks) | 384 ch, 14×14 |
| Downsample + Stage 4 (3 blocks) | 768 ch,  7×7  |
...
ConvNeXtTiny/
├── NoteBook/
│   └── ConvNeXtTiny.ipynb          # 17-cell interactive walkthrough
├── Python Scripts/
│   ├── ConvNeXtTiny.py             # Architecture from scratch
