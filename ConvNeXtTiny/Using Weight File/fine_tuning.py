"""
Two-phase fine-tuning for ConvNeXtTiny:
...
cbs_1 = [
    ModelCheckpoint("convnext_tiny_phase1_best.keras",
...
cbs_2 = [
    ModelCheckpoint("convnext_tiny_fine_tuned_best.keras",
                    monitor="val_accuracy", save_best_only=True, verbose=1),
    ReduceLROnPlateau(monitor='val_loss', factor=0.1,
...
model.save("convnext_tiny_fine_tuned_final.keras")
