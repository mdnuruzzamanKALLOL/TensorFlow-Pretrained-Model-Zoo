"""
Phase 1 only (frozen base): train a new head on top of pretrained ConvNeXtTiny.
"""
...
callbacks = [
    ModelCheckpoint("convnext_tiny_fe_best.keras",
...
model.save("convnext_tiny_feature_extraction.keras")
