...
model   = keras.Model(inputs=base_model.input, outputs=outputs, name='resnet50_fe')
...
# ── Data generators — ResNet50 preprocessing ──
...
callbacks = [
    keras.callbacks.ModelCheckpoint(
        'resnet50_fe.keras', monitor='val_accuracy',
